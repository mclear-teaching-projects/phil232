...
* Week 12 (4/2)
** Quiz
1. T/F: Locke construes knowledge as a relation between an idea and the world
   - F
2. T/F: Locke denies that knowledge must be certain
   - F
3. T/F: Locke agrees with Descartes that we can achieve a demonstrative
   science of nature
   - F
4. Describe what it is for the connection between the primary and
   secondary qualities of an object to be "inscrutable"
   - derivation of particular sensory "secondary" qualities from "primary"
     qualities is unintelligible (at least to us) 
5. T/F: Leibniz thinks that the existence of material atoms would be
   arbitrary and thus violate the PSR
   - T 
** Locke
...
**** Matter is not fundamental (not fundamentally real)

- Principle of Borrowed Reality (PBR) :: every being derives its reality only
     from the reality of those beings of which it is composed
...
5. \therefore There exists something else which is not itself material and which is
   responsible for the existence of body

- This argument, if sound, shows that the reality of matter is not something
  fundamental, but rather must explained in non-material terms. 
- There are two possible readings of this conclusion, a 'liberal', and an
  'austere' reading.
***** Liberal reading
According to the liberal reading we can say that matter is real but not
fundamental---it is rather derived from the non-material in the sense in which
the sound of an orchestra is derived from the sounds of the individual players
in the orchestra. 
***** The austere reading
The austere reading reserves the term 'real' for those things that are
fundamental, so it denies that matter is real, understood as something existing
over and above that of the fundamental non-material entities. The analogue here
would be to deny the real existence of the sound of the orchestra because there
is no sound that really exists over and above the existence of the sounds of
each of the individual instruments.

- What about the importance of the arrangement of the parts making up any
  particular body? Wouldn't that be a potential source of reality which would
  end the 'reality regress'? 
  - No. Leibniz denies the ultimate reality of relations/relational
    properties. This means that we cannot find, in the relations that exist
    between the parts of a thing, some source of reality that might stop the
    regress.
...
1. Unity
   - does not have independent parts
2. Independence
   - does not inhere in anything else
3. Persistence
   - identity of being through change 
4. Activity
   - a substance is necessarily active or possesses principle of change (for
     some purpose - final causation)
5. Individuation
   - a substance has a principle of individuation intrinsic to its nature 


**** The characteristics of monads

1. Simplicity
   - has no parts -- is a true unity
2. Indestuctibility
   - possesses no parts
3. Immateriality
   - has no parts so cannot be material
4. Individuality
   - perception
     - various states of the monad, conscious or not
   - appetite
     - principle of succession
5. 'Windowlessness' (causal isolation/independence)
   - Why must monads be 'windowless'? Leibniz thinks there is no sense to be
     made of causal interaction between monads. Causal interaction would
     result either in (i) the rearrangement of parts, but monads don't have
     parts, or (ii) the transmission of an 'accident' from one thing to
     another, which Leibniz thinks is incoherent.
   #+BEGIN_QUOTE
     ...
     composites, where there can be change among the parts. The monads have no
     windows through which something can enter or leave. Accidents cannot be
     detached, nor can they go about outside of substances, as the sensible
     species of the Scholastics once did. Thus, neither substance nor accident
     can enter a monad from without. (§7, pp.213-14)
   #+END_QUOTE

**** The Ideality of Matter
- Physical objects 'result' from monads
    - monads 'express' bodies via 'perception'
    - physical bodies are a kinds of stable hallucination---a 'well-founded phenomenon'
- Monads are not literal /parts/ of bodies --- rather monads 'express' them.
  Matter is thus derivative from the perceptions of monads

  
* Week 13 (4/9)
** Quiz
 1. T/F: Leibniz thinks that because matter is infinitely divisible it can
    exist independently of other things and thus qualifies as a substance
    - F
 2. Name one of the characteristics of a monad
    - simple (has no parts)
    - immaterial
    - unity
    - individual (perception & appetite)
    - "windowless" 
 3. T/F: Monads are individuated solely by their perceptions
    - F 
...
** Leibniz on Freedom
- Incompatibilism :: determinism and free will/freedom are incompatible 
- Compatibilism :: determinism and free will/freedom are compatible 

                   
- Leibniz argues for compatibilism based on what a counterpart might do in an
  alternate possible world (i.e. a world God could have created but didn't)
** Spinoza
- Born in Amsterdam in 1632, dies at The Hague in 1677

*** The Principle of Sufficient Reason
- PSR: :: For every fact F, there is a metaphysically sufficient explanation
          (or reason or ground) why F, rather than not F, is true


Three features of the PSR 

1. Irreflexive: if F explains G then F is not identical to G (i.e. nothing can
   explain itself)
2. Asymmetric: If F explains G then G does not explain F 
3. Transitive: If F explains G, and G explains H, then F explains H


- There are no brute explanations 
- The ground of explanation necessitates (i.e. makes necessary) that which it
  explains
- The PSR, applied unrestrictedly, entails determinism

This commitment to the unrestricted use of the PSR means that:
  
- Spinoza is not just a determinist but also a necessitarian

- Determinism :: every state of affairs is necessitated by antecedent
  states of affairs together with the laws of nature.
  
- Necessitarianism :: every truth is necessarily true.

***  Descartes's & Spinoza's conception of substance
Descartes's official definition of substance in terms of an independent individual:
...
#+BEGIN_QUOTE
  Hence the term ‘substance' does not apply /univocally/, as they say in
  the Schools, to God and other things; that is, there is no distinctly
  intelligible meaning of the term which is common to God and his
  creatures. (/Principles/, §51)
#+END_QUOTE

- Descartes denies that there is a single sense in which one can apply the
  term 'substance'
...
#+BEGIN_QUOTE
  ...
  conception of another thing from which it has to be formed. (E1d3)
#+END_QUOTE

*** Spinoza's Argument for Monism
Spinoza's argument for monism ultimately looks like this: 

1. No two substances share an attribute
2. God has infinite attributes (i.e. God has /all/ the attributes) 
3. \therefore There can be no substance other than God
...
**** Argument for step 1
Spinoza's argument that no two substances can share an attribute looks like this:

1. If two substances exist, then they can be distinguished (from the [[https://plato.stanford.edu/entries/identity-indiscernible/][Identity
   of Indiscernibles]])
2. E1p4: If two substances can be distinguished, then they are distinguished
   either by a difference in attribute or a difference in mode
3. No two substances can be distinguished by a difference in mode (from E1d3,
   E1a6, E1p1)
4. \therefore Two substances are distinguished by their attributes (from 1, 2, and 3)
5. If two substances are distinguished by their attributes, then they cannot
   share an attribute
6. \therefore Two substances cannot share an attribute

   
A. E1d3: Substance is conceived through itself
B. E1d5: Modes are conceived through something other than the substance to which they belong
C. E1p1: Therefore, substances are (conceptually) prior to their modes
D. Substance considered in itself therefore excludes consideration of modes (from A, B & C)
E. \therefore Substances cannot be distinguished by a difference in their modes (= 3 above)
...
2. E1d6: By God I understand a being absolutely infinite, that is, a substance
         consisting of an infinity of attributes, of which each one expresses an eternal and infinite essence 
3. E1p11: \therefore God necessarily exists and has infinite attributes (from E1p7 &
   E1d6)
...
** Hume's Mind
*** The Project
- Two aims: positive and negative
  - Positive: The human mind operates on sense impressions and their
    corresponding ideas, according to principles of association 
  - Negative: The pursuit of metaphysical questions is fruitless and perhaps
    such claims lack meaning altogether
...
- Two aims: positive and negative
  - Positive: The human mind operates on sense impressions and their
    corresponding ideas, according to principles of association 
  - Negative: The pursuit of metaphysical questions is fruitless
...
Ideas are less forceful and lively copies of impressions

*** The Copy Principle

- All ideas are copies from original impressions
- If all our ideas must be copied from impressions and our impressions could
  always change, then how can we be certain that we know anything? 

*** The missing shade of blue
- Must all ideas be traceable to original impressions?
  - No? Missing shade of blue counterexample

    - Alternative explanations
      - unreliable in figuring out which ideas we have based on our
        impressions
      - already had the impression but didn't realize it
      - have a complex idea of the shade rather than a simple one

  - Counterexample doesn't matter because it is "so singular" 

  - Important because it is relevant to assessing copy principle as a
    principle determining what thoughts are meaningful
...
*** Example of nonsense
Lewis Carroll's "[[https://www.poetryfoundation.org/poems/42916/jabberwocky][Jabberwocky]]"
...
- Is metaphysics like the poem -- ultimately all word play and association, or
  is in a genuine form of inquiry? 
  
*** Three Kinds of Association

1. resemblance
2. contiguity in space and/or time
3. cause & effect

Association is the natural means by which the mind relates its ideas and impressions.
...
Analytic truths are propositions which are true:

i. in virtue of their negation being a contradiction 
ii. in virtue of the predicate being 'contained' in the subject 
iii. in virtue of the meaning of the constituent concepts/words

*** A priori Justification & Knowledge

i. Justification/Knowledge which is derived or possessed independently of experience (i.e. independent of perception, introspection, memory, and perhaps testimony) needed to understand the proposition at issue.

ii. Justification/Knowledge of causes/grounds rather than effects

- a posteriori knowledge/justification is knowledge that /does/ depend on experience
  - e.g. "It is snowing in Lincoln"

  
*** Knowledge of Matters of Fact
- We have knowledge of occurrent matters of fact via our occurrent experience
- What gives us knowledge/certainty of anything beyond what we're currently sensing?
  - all reasoning about whatever is not immediately occurrent depends on
    appeal to cause/effect relation 

 
*** Hume's argument against rationality of causal principle
- Our conclusions based on the principle of cause/effect are not rational


**** Negative Argument

***** Causal knowledge is not attained via relations of ideas
- The relation of an effect to its cause (and vice versa) can never be attained
  merely by the analysis of ideas and their relations
- No contradiction is implied by denying that some effect follows from some
  putative cause
- There are no necessary connections between distinct existences


***** Causal knowledge is not attained via a rational process of induction from cases
- Hume denies that there is any rational process of arriving at a causal
  conclusion based on reasoning 
  1. In the past when I've had caffeine I have felt more alert 
  2. therefore when I have this caffeine I will feel more alert 
- We have no defensible rational justification for believing (2) on the basis of (1)
  

**** Positive Argument
***** Custom or Habit
***** Redefinition of 'cause' 
* Week 15 (4/23)
** Quiz
1. Hume distinguishes between two kinds of perception -- what are they?
   - impressions & ideas
2. Name one law of association
   - cause/effect
   - resemblance
   - contiguity in time and/or space
3. What is the copy principle?
   - all simple ideas are "copied" or derived from impressions 
4. "Hume's Fork" distinguishes between two different kinds of knowledge. Name one
   - matters of facts & relations between ideas
5. T/F: Hume thinks that we perceive necessary connections (i.e. causal
...
- Hume denies that there is any rational process of arriving at a causal
  conclusion based on reasoning 
  1. In the past when I've had caffeine I have felt more alert (perhaps there
     are a great many premises of this kind) 
  2. therefore when I have this caffeine I will feel more alert 
- We have no defensible rational justification for believing (2) on the basis of (1)
  - No contradiction involved in ingesting caffeine but denying alertness 
  - We can't logically demonstrate that alertness results from ingesting caffeine
  - No impression of a necessary relation between distinct events or objects
  - No non-circular justification of inferences from (1) - (2) 
    - Any rational basis for induction requires the justified belief or
      knowledge that the future will be like the past (FLP)
    - Why think that FLP is true? (i.e. why think we are justified in believing
      it is true?)
      - No impression/experience of FLP
      - No logical demonstration of FLP 
      - No contradiction generated by denying FLP
      - Cannot defend FLP by induction without vicious circularity 

**** Positive Argument
***** Custom or Habit (p. 29 Hackett)
- If reason/reasoning doesn't lead us to believe that the future will be like
  the past then what does?
  - Custom/habit

***** Redefinition of 'cause' (p. 51, Hackett)
- We never experience necessary connection
- We can't derive a notion of 'cause' from relation between ideas
- No legitimate use of 'cause' that means 'necessary connection'

****** i. 'causation' means 'constant conjunction'
- If A causes B then that means that As are typically (or always) followed by Bs
****** ii. 'causation' means 'counterfactual dependence'
- If A causes B then that means that were A not to have occurred then B
